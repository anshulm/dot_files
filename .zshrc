...
alias gs="git status"
alias gpr="git pull --rebase"
alias gglog="git log --graph --pretty=format:'%C(yellow)%h%Creset  %C(cyan)%s%n         %Cgreen%an%Cred  %Creset%cd'"
alias glog="git log --pretty=format:'%C(yellow)%h%Creset  %C(cyan)%s%n         %Cgreen%an%Cred  %Creset%cd'"
